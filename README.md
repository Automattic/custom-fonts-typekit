...
Note: if you use your `.wpsandbox.me` for testing wpcomsh, use ssh key forwarding so you have all your local ssh keys on the wpsandbox and can clone the wpcomsh GitHub repo. Either run ssh as `ssh -A` or add `ForwardAgent yes` into your `.ssh/config` file. [More info on Slack](https://a8c.slack.com/archives/C2PDURDSL/p1490809471078673).
...
- After merging everything on the trunk branch strings on [wpcomsh.pot](./languages/wpcomsh.pot) file will be automatically inserted into our translation system [by this script](https://opengrok.a8c.com/source/xref/wpcom/bin/i18n/import-github-originals.php?r=1bd4d3bb&mo=12&fi=2#5).
...
https://logstash.a8c.com/kibana4/goto/78d11cc3116d62c53c50ae95c04d265b
...
[Coming Soon](https://fieldguide.automattic.com/coming-soon-public-by-default/) mode is provided via the [jetpack-mu-wpcom package](https://fieldguide.automattic.com/developing-jetpack/jetpack-mu-wpcom/) and enabled using a filter. Coming Soon allows users to hide their site behind a Coming Soon page from the site settings page of Calypso.
